package dataEngineering.data.consumer;

import com.google.gson.JsonParser;
import dataEngineering.data.credentials.TokenAndKey;
...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = TokenAndKey.BONSAI_URL; // localhost or bonsai url
        String username = TokenAndKey.BONSAI_USERNAME; // needed only for bonsai
        String password = TokenAndKey.BONSAI_PASSWORD; // needed only for bonsai
